...
**Skip this phase if CROSS_SPEC is "false" or not set.**
...
**Note:** Cross-spec sync is more conservative - only flag clear references, not general topic overlap.
...
Updated tasks (cross-spec):  # Only if CROSS_SPEC enabled and found
